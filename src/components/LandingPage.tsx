  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-blue-200 to-indigo-300 px-4 py-16 sm:px-6 lg:px-8 dark:from-gray-900 dark:to-gray-950">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/2 left-1/2 h-[1000px] w-[1000px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-blue-300 to-purple-300 opacity-30 blur-3xl dark:from-blue-900 dark:to-purple-900"></div>
